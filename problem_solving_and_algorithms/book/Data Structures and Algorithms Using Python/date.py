...
class Date :
    ...
    def __init__( self, month, day, year ): 
        ...
        # The first line of the equation, T = (M - 14) / 12, has to be changed # since Python's implementation of integer division is not the same
